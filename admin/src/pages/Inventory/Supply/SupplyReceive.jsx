...
const SupplyReceive = () => {
    ...
    const fetchSupplyOrder = async () => {
        try {
            ...
            if (
                ...
                setError(
                    `Cannot receive stock for a ${order.status} order.`
                );
                setData(order);
                return;
            }
    ...
    const validate = () => {
        ...
        data.items?.forEach((item) => {
            ...
            if (quantity > remaining) {
                newErrors[item.id] =
                    `Maximum ${remaining} can be received.`;
                return;
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await api.post(
                `/inventory/supply-orders/${id}/receive/`,
                {
                    items,
                }
            );
            ...
            <div className="details-card">
                ...
                <div className="details-card-header">
                    ...
                    <div>
                        ...
                        <span>
                            Review the supply order before receiving stock
                        </span>
                    </div>
